...
export default function AccueilScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    cardValue: { fontSize: 24, fontWeight: '800', color: colors.text, marginBottom: 4 },
    ...
    themeDemoText: { fontSize: 15, color: colors.text, marginBottom: 16, textAlign: 'center', lineHeight: 22 },
    themeDemoButton: { 
    ...
    themeDemoButtonText: { color: '#ffffff', fontWeight: '700', fontSize: 15 },
  });
